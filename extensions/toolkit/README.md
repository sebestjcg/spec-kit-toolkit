...
```bash
specify extension add https://github.com/sebestjcg/spec-kit-toolkit/releases/download/vX.Y.Z/spec-kit-toolkit-extension-X.Y.Z.zip
```
...
`specify extension add <url>` works on the release asset).
