...
```bash
specify preset add --from https://github.com/sebestjcg/spec-kit-toolkit/releases/latest/download/claude-ask-questions-1.0.0.zip
```
...
# 5. If preset.yml version changed, update the zip filename in the --from URL in this README
```
